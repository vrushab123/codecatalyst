...
import "./GymWebsite.css";

const GymWebsite = () => {
    const htmlCode = `<!-- Navbar -->
   <nav
  ...
  `;
    ...
    const cssCode = `function toggleNavbar(collapseID) {
...
`;
    ...
    return (
        <div className="gym-website">
            ...
            <img
                src="/assets/GymWebsite.jpg"
                alt="Modern Login Form Preview"
                className="preview-image"
                style={{ filter: "brightness(153%)" }}
            />

            <h2 className="section-heading">HTML:</h2>
            <p className="description">
                This HTML code creates a webpage for a gym website. It includes a navigation bar, a hero section, a services section, a features section
            </p>
            ...
            <p className="description">
                This JS code is used to toggle the navbar on small screens. It also initializes AOS (Animate on Scroll). It also adds a smooth scroll effect to the navbar links.
            </p>
            ...
            <button
                ...
                onClick={() => {
                    const fileUrl = "/files/Gym-Website.zip";
                    const link = document.createElement("a");
                    link.href = fileUrl;
                    link.download = "Gym-Website.zip";
                    link.click();
                }}
            >
